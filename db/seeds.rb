...
if Rails.env.development?
  ...
  AccessLog.create!(user_id: user4.id, card_number: card4.card_number, lock_id: main_entrance.id, access_method: 'access_card', access_provided: false, direction: 'enter')
  sleep(1)
  AccessLog.create!(user_id: user4.id, card_number: card4.card_number, lock_id: main_entrance.id, access_method: 'access_card', access_provided: false, direction: 'exit')
  sleep(1)
  AccessLog.create!(user_id: user4.id, card_number: card4.card_number, lock_id: main_entrance.id, access_method: 'access_card', access_provided: false, direction: 'enter')
  sleep(1)
  AccessLog.create!(user_id: user4.id, card_number: card4.card_number, lock_id: main_entrance.id, access_method: 'access_card', access_provided: false, direction: 'exit')
